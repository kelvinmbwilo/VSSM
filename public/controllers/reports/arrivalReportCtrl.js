...
angular.module("vssmApp")
    .controller("arrivalReportCtrl",function ($scope,$http,$mdDialog,$mdToast,$modal,$translate,$filter,DTOptionsBuilder, DTColumnBuilder) {
//getting all regions
        $scope.data = {};
        ...
        $scope.filterDataStatus = function(vaccine_id,period){
            ...
            result.data = [];
            var count = 0;
            angular.forEach($scope.filterFilters($scope.filterTime( $scope.data.arrivalItems,period)),function(val){
