/**
* Created by Florence 31/08/2016
*/

angular.module("vssmApp")
     .controller("expiredItemsReportCtrl", function ($scope, $http, $mdDialog, $mdToast, $modal, $translate, $filter, DTOptionsBuilder, DTColumnBuilder){
     // getting all regions
        $scope.data = {};
        ...
        $scope.months = [{name: "January", ticked: true}, {name: "February", ticked: true}, {name: "March", ticked: true}, {name: "April", ticked: true}, {name: "May", ticked: true}, {name: "June", ticked: true}, {name: "July", ticked: true}, {name: "August", ticked: true}, {name: "September", ticked: true}, {name: "October", ticked: true}, {name: "November", ticked: true}, {name: "December", ticked: true}];
        ...
        $scope.fetchData = function(){
        	$http.get('index.php/expiredItems/'+ $scope.data.children + '/child' + $scope.selected_level).success(function (data){
        		$scope.data.expiredItems = data;
        	});
        }
        ...
        $scope.prepareSeries = function(){
        	$scope.chartConfig.title.text = "Expired Items";
        	$scope.area = [];
        	if ($scope.data.reportPeriod == "Years"){
        ...
        $scope.filterDataStatus = function(vaccine_id, period){
        	...
        	result.data = [];
        	var count = 0;
        	angular.forEach($scope.filterFilters($scope.filterTime($scope.data.expiredItems, period)), function(val){
